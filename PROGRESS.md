...
| 2. Export programmatic API function | not-started | |
| 3. Implement subagent delegation handling | not-started | |
| 4. Add automated tests for all flows | not-started | |
| 5. Documentation / README snippet | not-started | |
