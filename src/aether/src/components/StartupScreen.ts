/**
 * Aether startup screen — filled-block text logo with sunset gradient.
...
const LOGO_AETHER = [
  ...
  '        dP    88          88888888I8  8I                        ',
  '       ,8\'    88             I8   I8  8\'                        ',
  '       d88888888    ,ggg,    I8   I8 dPgg,    ,ggg,    ,gggggg, ',
  ' __   ,8"     88   i8" "8i   I8   I8dP" "8I  i8" "8i   dP""""8I ',
  'dP"  ,8P      Y8   I8, ,8I  ,I8,  I8P    I8  I8, ,8I  ,8\'    8I ',
  'Yb,_,dP       `8b, `YbadP\' ,d88b,,d8     I8, `YbadP\' ,dP     Y8,',
  ' "Y8P"         `Y8888P"Y8888P""Y8888P     `Y8888P"Y8888P      `Y8',
]
...
export function printStartupScreen(): void {
  ...
  out.push(`${rgb(...BORDER)}\u255a${'\u2550'.repeat(W - 2)}\u255d${RESET}`)
  out.push(`  ${DIM}${rgb(...DIMCOL)}Aether ${RESET}${rgb(...ACCENT)}v${MACRO.DISPLAY_VERSION ?? MACRO.VERSION}${RESET}`)
  out.push('')
