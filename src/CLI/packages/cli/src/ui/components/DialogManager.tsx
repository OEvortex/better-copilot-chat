...
export const DialogManager = ({
  ...
  if (uiState.isAuthenticating) {
    ...
    // Aether OAuth remains as a separate flow
    if (uiState.pendingAuthType === AuthType.AETHER_OAUTH) {
      return (
        <AetherOAuthProgress
          deviceAuth={uiState.aetherAuthState.deviceAuth || undefined}
          authStatus={uiState.aetherAuthState.authStatus}
          authMessage={uiState.aetherAuthState.authMessage}
          onTimeout={() => {
            uiActions.onAuthError('Aether OAuth authentication timed out.');
