...
describe('loggers', () => {
  ...
  describe('logChatCompression', () => {
    beforeEach(() => {
      ...
      vi.spyOn(AetherLogger.prototype, 'logChatCompressionEvent');
    });

    it('logs the chat compression event to AetherLogger', () => {
      ...
      expect(AetherLogger.prototype.logChatCompressionEvent).toHaveBeenCalledWith(
        event,
      );
    });
  ...
  describe('logRipgrepFallback', () => {
    ...
    beforeEach(() => {
      vi.spyOn(AetherLogger.prototype, 'logRipgrepFallbackEvent');
    });
    ...
    it('should log ripgrep fallback event', () => {
      ...
      expect(AetherLogger.prototype.logRipgrepFallbackEvent).toHaveBeenCalled();
  ...
  describe('logMalformedJsonResponse', () => {
    beforeEach(() => {
      vi.spyOn(AetherLogger.prototype, 'logMalformedJsonResponseEvent');
    });
    ...
    it('logs the event to Clearcut and OTEL', () => {
      ...
      expect(
        AetherLogger.prototype.logMalformedJsonResponseEvent,
  ...
  describe('logExtensionInstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(AetherLogger.prototype, 'logExtensionInstallEvent');
    });
    ...
    it('should log extension install event', () => {
      ...
      expect(
        AetherLogger.prototype.logExtensionInstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionUninstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(AetherLogger.prototype, 'logExtensionUninstallEvent');
    });
    ...
    it('should log extension uninstall event', () => {
      ...
      expect(
        AetherLogger.prototype.logExtensionUninstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionEnable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(AetherLogger.prototype, 'logExtensionEnableEvent');
    });
    ...
    it('should log extension enable event', () => {
      ...
      expect(AetherLogger.prototype.logExtensionEnableEvent).toHaveBeenCalledWith(
        event,
      );
  ...
  describe('logExtensionDisable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(AetherLogger.prototype, 'logExtensionDisableEvent');
    });
    ...
    it('should log extension disable event', () => {
      ...
      expect(
        AetherLogger.prototype.logExtensionDisableEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logHookCall', () => {
    ...
    const mockAetherLogger = {
      logHookCallEvent: vi.fn(),
    };

    beforeEach(() => {
      vi.spyOn(AetherLogger, 'getInstance').mockReturnValue(
        mockAetherLogger as unknown as AetherLogger,
      );
      mockAetherLogger.logHookCallEvent.mockClear();
    });

    it('should log a successful hook call to AetherLogger', () => {
      ...
      // Should call AetherLogger
      expect(mockAetherLogger.logHookCallEvent).toHaveBeenCalledWith(event);
    });
    ...
    it('should handle when AetherLogger is not available', () => {
      vi.spyOn(AetherLogger, 'getInstance').mockReturnValue(undefined);
      ...
      // Should not throw when AetherLogger is not available
    ...
    it('should pass the exact event object to AetherLogger', () => {
      const event = new HookCallEvent(
        'PreToolUse',
        'command',
        'test-hook.sh',
      ...
      expect(mockAetherLogger.logHookCallEvent).toHaveBeenCalledTimes(1);
      const passedEvent = mockAetherLogger.logHookCallEvent.mock.calls[0][0];
