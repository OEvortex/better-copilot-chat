...
async function platformDir() {
    try {
        ...
        console.log(
            'Could not resolve @vscode/chat-lib, skipping tokenizer files'
        );
        return null;
    }
}
...
function treeSitterWasmDir() {
    try {
        ...
        console.warn(
            'Could not resolve @vscode/tree-sitter-wasm, skipping tree-sitter files'
        );
        return null;
    }
}
...
async function build() {
    try {
        if (isWatch) {
            ...
            console.log(
                'Starting watch mode for extension and copilot bundles...'
            );
            ...
            console.log(
                'Watching for changes in both extension.js and copilot.bundle.js...'
            );
        } else {
