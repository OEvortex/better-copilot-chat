import { CancellationToken, Disposable, DocumentSelector, DocumentUri, Position, TextEdit } from 'vscode-languageserver-protocol';
/**
...
export {};
//# sourceMappingURL=contextProviderApiV1.d.ts.map