...
export declare class LocationFactory {
    static range: typeof Range.create;
    static position: typeof Position.create;
}
interface Line {
    /**
...
export interface INotebookDocument {
    ...
    getCellFor({ uri }: {
        uri: string;
    }): INotebookCell | undefined;
}
export declare class CopilotTextDocument implements ITextDocument {
    readonly uri: string;
     ...
     */
    static withChanges(textDocument: ITextDocument, changes: TextDocumentContentChangeEvent[], version: number): CopilotTextDocument;
    /**
     ...
     */
    applyEdits(edits: TextEdit[]): CopilotTextDocument;
    static create(uri: string, languageId: string, version: number, text: string, detectedLanguageId?: string): CopilotTextDocument;
