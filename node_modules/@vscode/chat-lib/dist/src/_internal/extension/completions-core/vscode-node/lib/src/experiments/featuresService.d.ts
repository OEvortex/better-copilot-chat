...
export type CompletionsFiltersInfo = {
    uri: string;
    languageId: string;
};
...
export declare const ICompletionsFeaturesService: import("../../../../../../util/common/services").ServiceIdentifier<ICompletionsFeaturesService>;
