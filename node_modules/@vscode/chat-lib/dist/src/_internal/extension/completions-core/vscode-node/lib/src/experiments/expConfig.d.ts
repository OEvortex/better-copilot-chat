...
export declare enum ExpTreatmentVariables {
...
export declare class ExpConfig {
    variables: Partial<Record<ExpTreatmentVariables, ExpTreatmentVariableValue>>;
    features: string;
    constructor(variables: Partial<Record<ExpTreatmentVariables, ExpTreatmentVariableValue>>, features: string);
...
//# sourceMappingURL=expConfig.d.ts.map