...
let XtabEndpoint = class XtabEndpoint extends chatEndpoint_1.ChatEndpoint {
    ...
    get urlOrRequestMetadata() {
        return this._configService.getConfig(configurationService_1.ConfigKey.TeamInternal.InlineEditsXtabProviderUrl) || this._url;
    }
    getExtraHeaders() {
        const apiKey = this._configService.getConfig(configurationService_1.ConfigKey.TeamInternal.InlineEditsXtabProviderApiKey) || this._apiKey;
        if (!apiKey) {
