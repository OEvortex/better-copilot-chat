...
class NextEditCache extends lifecycle_1.Disposable {
    constructor(workspace, _logService, configService, expService) {
        super();
        ...
        (0, observableInternal_1.mapObservableArrayCached)(this, workspace.openDocuments, (doc, store) => {
            ...
            store.add((0, observable_1.autorunWithChanges)(this, {
                ...
                if (configService.getExperimentBasedConfig(configurationService_1.ConfigKey.Advanced.InlineEditsTriggerOnEditorChangeAfterSeconds, expService) !== undefined) {
    ...
    setNoNextEdit(docId, documentContents, editWindow, source) {
        const docCache = this._documentCaches.get(docId);
        if (!docCache) {
            return;
        }
...
class DocumentEditCache {
    ...
    setNoNextEdit(documentContents, editWindow, source) {
        const key = this._getKey(documentContents.value);
