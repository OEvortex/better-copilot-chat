...
class ChatMLFetcherTelemetrySender {
    static sendSuccessTelemetry(telemetryService, { chatCompletion, baseTelemetry, userInitiatedRequest, chatEndpointInfo, requestBody, maxResponseTokens, promptTokenCount, timeToFirstToken, timeToFirstTokenEmitted, hasImageMessages, fetcher }) {
        /* __GDPR__
            "response.success" : {
                "owner": "digitarald",
    ...
    static sendCancellationTelemetry(telemetryService, { source, requestId, model, apiType, associatedRequestId, retryAfterErrorCategory, retryAfterError, retryAfterErrorGitHubRequestId, connectivityTestError, connectivityTestErrorGitHubRequestId, retryAfterFilterCategory, fetcher, }, { totalTokenMax, promptTokenCount, tokenCountMax, timeToFirstToken, timeToFirstTokenEmitted, timeToCancelled, isVisionRequest, isBYOK, isAuto }) {
        /* __GDPR__
            "response.cancelled" : {
                "owner": "digitarald",
    ...
    static sendResponseErrorTelemetry(telemetryService, processed, telemetryProperties, chatEndpointInfo, requestBody, tokenCount, maxResponseTokens, timeToFirstToken, isVisionRequest, fetcher) {
        /* __GDPR__
            "response.error" : {
                "owner": "digitarald",
