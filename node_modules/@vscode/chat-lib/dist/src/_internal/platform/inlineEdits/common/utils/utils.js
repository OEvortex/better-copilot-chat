...
exports.Icon = void 0;
exports.overrideNowValue = overrideNowValue;
exports.now = now;
exports.shortenOpportunityId = shortenOpportunityId;
exports.checkIfCursorAtEndOfLine = checkIfCursorAtEndOfLine;
const themables_1 = require("../../../../util/vs/base/common/themables");
let overridenNowValue = -1;
function overrideNowValue(value) {
...
(function (Icon) {
    Icon.circleSlash = {
        themeIcon: themables_1.ThemeIcon.fromId('circle-slash'),
    ...
    Icon.error = {
        themeIcon: themables_1.ThemeIcon.fromId('error'),
    ...
    Icon.skipped = {
        themeIcon: themables_1.ThemeIcon.fromId('testing-skipped-icon'),
    ...
    Icon.lightbulbFull = {
        themeIcon: themables_1.ThemeIcon.fromId('refactor-preview-view-icon'),
    ...
    Icon.database = {
        themeIcon: themables_1.ThemeIcon.fromId('database'),
...
function shortenOpportunityId(opportunityId) {
...
function checkIfCursorAtEndOfLine(lineWithCursor, cursorOffsetZeroBased) {
