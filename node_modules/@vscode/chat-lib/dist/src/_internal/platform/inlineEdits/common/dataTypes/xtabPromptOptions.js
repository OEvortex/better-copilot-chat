...
exports.MODEL_CONFIGURATION_VALIDATOR = exports.LANGUAGE_CONTEXT_ENABLED_LANGUAGES = exports.DEFAULT_OPTIONS = exports.ResponseFormat = exports.PromptingStrategy = exports.AggressivenessLevel = void 0;
exports.isPromptingStrategy = isPromptingStrategy;
...
(function (PromptingStrategy) {
     ...
     */
    PromptingStrategy["CopilotNesXtab"] = "copilotNesXtab";
    ...
    PromptingStrategy["XtabAggressiveness"] = "xtabAggressiveness";
})(PromptingStrategy || (exports.PromptingStrategy = PromptingStrategy = {}));
function isPromptingStrategy(value) {
    return Object.values(PromptingStrategy).includes(value);
}
var ResponseFormat;
