...
(function (NoNextEditReason_1) {
    class NoNextEditReason {
    }
    class ActiveDocumentHasNoEdits extends NoNextEditReason {
        constructor() {
            super(...arguments);
    ...
    NoNextEditReason_1.ActiveDocumentHasNoEdits = ActiveDocumentHasNoEdits;
    class NoSuggestions extends NoNextEditReason {
        constructor(documentBeforeEdits, window, nextCursorPosition) {
            super();
            this.documentBeforeEdits = documentBeforeEdits;
            this.window = window;
            this.nextCursorPosition = nextCursorPosition;
    ...
    NoNextEditReason_1.NoSuggestions = NoSuggestions;
    class GotCancelled extends NoNextEditReason {
        constructor(message) {
            super();
    ...
    NoNextEditReason_1.GotCancelled = GotCancelled;
    class FetchFailure extends NoNextEditReason {
        constructor(error) {
            super();
            this.error = error;
    ...
    NoNextEditReason_1.FetchFailure = FetchFailure;
    class FilteredOut extends NoNextEditReason {
        constructor(message) {
            super();
            this.message = message;
    ...
    NoNextEditReason_1.FilteredOut = FilteredOut;
    class PromptTooLarge extends NoNextEditReason {
        constructor(message) {
            super();
            this.message = message;
    ...
    NoNextEditReason_1.PromptTooLarge = PromptTooLarge;
    class Uncategorized extends NoNextEditReason {
        constructor(error) {
            super();
            this.error = error;
    ...
    NoNextEditReason_1.Uncategorized = Uncategorized;
    class Unexpected extends NoNextEditReason {
        constructor(error) {
            super();
            this.error = error;
    ...
    NoNextEditReason_1.Unexpected = Unexpected;
...
class StatelessNextEditTelemetryBuilder {
     ...
     */
    setNextCursorLineDistance(distance) {
