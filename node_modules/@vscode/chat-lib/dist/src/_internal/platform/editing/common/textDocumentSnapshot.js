...
class TextDocumentSnapshot {
    ...
    static fromNewText(text, doc) {
        return new TextDocumentSnapshot(doc instanceof TextDocumentSnapshot ? doc.document : doc, doc.uri, text, doc.languageId, doc.eol, doc.version + 1);
    }
    ...
    lineAt(lineOrPosition) {
        let line;
        if (lineOrPosition instanceof vscodeTypesShim_1.Position) {
    ...
    getWordRangeAtPosition(_position) {
        ...
        if (wordAtText) {
            return new vscodeTypesShim_1.Range(position.line, wordAtText.startColumn - 1, position.line, wordAtText.endColumn - 1);
        }
        return undefined;
    }
    validateRange(range) {
        ...
        return new vscodeTypesShim_1.Range(start.line, start.character, end.line, end.character);
    }
...
class SnapshotDocumentLine {
    ...
    get range() {
        return new vscodeTypesShim_1.Range(this._line, 0, this._line, this._text.length);
    }
    get rangeIncludingLineBreak() {
        if (this._isLastLine) {
            return this.range;
        }
        return new vscodeTypesShim_1.Range(this._line, 0, this._line + 1, 0);
    }
