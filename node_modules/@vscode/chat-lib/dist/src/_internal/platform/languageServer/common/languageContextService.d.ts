...
export declare const ILanguageContextService: import("../../../util/common/services").ServiceIdentifier<ILanguageContextService>;
...
export declare enum KnownSources {
    unknown = "unknown",
    sideCar = "sideCar",
...
export declare const NullLanguageContextService: ILanguageContextService;
//# sourceMappingURL=languageContextService.d.ts.map