...
export declare function isEndpointEditToolName(toolName: string): toolName is EndpointEditToolName;
...
export declare enum ModelSupportedEndpoint {
...
export declare function isChatModelInformation(model: IModelAPIResponse): model is IChatModelInformation;
export declare function isEmbeddingModelInformation(model: IModelAPIResponse): model is IEmbeddingModelInformation;
...
export declare function isCompletionModelInformation(model: IModelAPIResponse): model is ICompletionModelInformation;
...
export declare const IEndpointProvider: import("../../../util/common/services").ServiceIdentifier<IEndpointProvider>;
export {};
//# sourceMappingURL=endpointProvider.d.ts.map