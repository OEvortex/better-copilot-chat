...
class BaseCAPIClientService extends copilot_api_1.CAPIClient {
    constructor(hmac, integrationId, fetcherService, envService) {
        super({
        ...
        }, licenseAgreement_1.LICENSE_AGREEMENT, fetcherService, hmac, integrationId);
    }
    makeRequest(request, requestMetadata) {
        ...
        return super.makeRequest(request, requestMetadata);
    }
}
