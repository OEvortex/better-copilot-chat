 ...
 */
let AutoChatEndpoint = class AutoChatEndpoint extends copilotChatEndpoint_1.CopilotChatEndpoint {
    static { this.pseudoModelId = 'auto'; }
    constructor(_wrappedEndpoint, _sessionToken, _discountPercent, discountRange, _domainService, _capiClientService, _fetcherService, _envService, _telemetryService, _authService, _chatMLFetcher, _tokenizerProvider, _instantiationService, _configurationService, _expService, _logService) {
        super(calculateAutoModelInfo(_wrappedEndpoint, _sessionToken, _discountPercent), _domainService, _capiClientService, _fetcherService, _envService, _telemetryService, _authService, _chatMLFetcher, _tokenizerProvider, _instantiationService, _configurationService, _expService, _logService);
...
exports.AutoChatEndpoint = AutoChatEndpoint = __decorate([
    ...
    __param(14, nullExperimentationService_1.IExperimentationService),
    __param(15, logService_1.ILogService)
], AutoChatEndpoint);
