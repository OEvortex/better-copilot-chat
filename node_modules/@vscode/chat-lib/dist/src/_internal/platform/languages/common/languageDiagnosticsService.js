...
function isError(diagnostics) {
    return diagnostics.severity === vscodeTypesShim_1.DiagnosticSeverity.Error;
}
function getDiagnosticsAtSelection(diagnostics, selection, severities = [vscodeTypesShim_1.DiagnosticSeverity.Error, vscodeTypesShim_1.DiagnosticSeverity.Warning]) {
