...
(function (ChatLocation) {
     ...
     */
    ChatLocation[ChatLocation["ResponsesProxy"] = 8] = "ResponsesProxy";
...
function getRateLimitMessage(fetchResult, fallbackModel, hideRateLimitTimeEstimate) {
...
function getErrorDetailsFromChatFetchError(fetchResult, fallbackModel, copilotPlan, hideRateLimitTimeEstimate) {
...
function getErrorDetailsFromChatFetchErrorInner(fetchResult, copilotPlan, fallbackModel, hideRateLimitTimeEstimate) {
    switch (fetchResult.type) {
        ...
        case ChatFetchResponseType.RateLimited:
            return {
                ...
                level: vscodeTypesShim_1.ChatErrorLevel.Info,
                isRateLimited: true
            };
