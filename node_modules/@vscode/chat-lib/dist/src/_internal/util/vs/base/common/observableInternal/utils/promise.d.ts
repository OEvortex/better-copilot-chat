...
export declare class ObservablePromise<T> {
    ...
    readonly resolvedValue: import("../base").IObservableWithChange<T | undefined, void>;
}
...
export declare class ObservableLazyPromise<T> {
     ...
     */
    readonly cachedPromiseResult: import("../base").IObservableWithChange<PromiseResult<T> | undefined, void>;
